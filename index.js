...
console.log("Connecting FAMILY-MD WHATSAPP BOT 💦...");
...
console.log('🧚‍♂️ FAMILY-MD-V1 Install Successfully. 🧚‍♂️')
...
console.log('FAMILY-MD-V1 Bot Connected to WhatsApp Succesful 🧬✅')
...
app.get("/", (req, res) => {
res.send("hey, family-md started🦠✅");
});
